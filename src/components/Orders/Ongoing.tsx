  ...
  return (
    <div className="">
              ...
              <div className="flex flex-wrap gap-[25px]">
                ...
                <div className="h-auto mb-[30px] w-[375px] rounded-[10px] border-[1px] border-[#404040] bg-[#A33C00]">
                  <div>
                ...
                <div className="h-auto mb-[60px] pb-[25px] w-[375px] rounded-[10px] border-[1px] border-[#404040] bg-[#A33C00]">
                  <div>
                    <div className="flex mt-[10px] ml-[-5px]">
                      <img src={man} width={50} height={50} alt="" />
                      <p className="text-[#D9D9D9] text-[14px] mt-[3px] ml-[-10px]">
